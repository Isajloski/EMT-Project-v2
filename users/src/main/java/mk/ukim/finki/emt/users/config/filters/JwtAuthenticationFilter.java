package mk.ukim.finki.emt.users.config.filters;
...
import mk.ukim.finki.emt.users.config.JwtAuthConstants;
import mk.ukim.finki.emt.users.domain.excep.PasswordsDoNotMatchException;
import mk.ukim.finki.emt.users.domain.model.BookUser;
import mk.ukim.finki.emt.users.domain.model.dto.UserDetailsDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            creds = new ObjectMapper().readValue(text, BookUser.class);
    ...
    public String generateJwt(HttpServletResponse response, Authentication authResult) throws JsonProcessingException {
        BookUser userDetails = (BookUser) authResult.getPrincipal();
